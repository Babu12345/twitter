...
public class TwitterClient extends OAuthBaseClient {
	...
	// CHANGE THIS
	// DEFINE METHODS for different API endpoints here
	public void getHomeTimelinePrev(long max_id, AsyncHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/home_timeline.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("counts", 25);
	...
	public void reTweet(long uid,  AsyncHttpResponseHandler handler){
		String apiUrl = getApiUrl("statuses/retweet/"+String.format("%d",uid)+".json");
		// Can specify query string params directly or through RequestParams.
	...
	public void Tweetdata(long uid,  AsyncHttpResponseHandler handler){
